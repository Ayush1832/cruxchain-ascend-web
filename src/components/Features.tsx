      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {features.map((feature, index) => (
            <div
              key={index}
              className={`feature-card-light dark:feature-card p-8 rounded-2xl transition-all duration-700 ${
            ...
            >
              <div className="relative">
                ...
                <div className="text-blue-600 dark:text-blue-400 mb-6 relative">
                  <div className="p-4 bg-blue-100 dark:bg-blue-500/10 rounded-xl border border-blue-200 dark:border-blue-500/20 inline-block">
                    {feature.icon}
                  </div>
                  <div className="absolute inset-0 bg-blue-200 dark:bg-blue-500/20 rounded-xl blur-xl opacity-50"></div>
                </div>
                ...
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-100/50 via-purple-100/50 to-green-100/50 dark:from-blue-500/10 dark:via-purple-500/10 dark:to-green-500/10 opacity-0 hover:opacity-100 transition-opacity duration-300 -z-10"></div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-20 text-center">
          <div className="inline-block glass-effect-light dark:glass-effect p-4 rounded-xl">
