...
const roadmapPhases = [
  {
    ...
    status: "completed",
    details: "Established brand identity, built community presence, and created comprehensive documentation."
  },
  {
    phase: "Phase 1",
    ...
    status: "in-progress",
    details: "Core intent-based transaction engine, basic token swapping, and Proof-of-Stake consensus."
  },
  {
    phase: "Phase 2",
    ...
    status: "upcoming",
    details: "Proof-of-Utility consensus upgrade, EVM compatibility, and WASM virtual machine support."
  },
  {
    phase: "Phase 3",
    ...
    status: "upcoming",
    details: "Advanced privacy features using zero-knowledge proofs for confidential transactions."
  },
  {
    phase: "Phase 4",
    ...
    status: "future",
    details: "AI-powered intent optimization, autonomous agents, and decentralized governance system."
  }
];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="relative">
            ...
            {roadmapPhases.map((phase, index) => (
              ...
              >
                {/* Timeline Node */}
                <div className={`absolute left-8 md:left-1/2 transform md:-translate-x-1/2 w-6 h-6 rounded-full bg-gradient-to-r ${getStatusColor(phase.status)} z-10 flex items-center justify-center shadow-lg`}>
